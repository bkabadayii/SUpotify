  ...
  @EnvironmentObject var viewModel: LikedSongsViewModel
    ...
    var body: some View {
      ForEach(viewModel.likedSongs, id: \._id){ song in
        ...
        HStack{
          LImage_RText(contentID: song._id, contentType: "TRACK", songName: song.name, artistNames: artists, imageURL: albumImageURL, previewURL: song.previewURL, isPlaylist: false).environmentObject(SharedViewModel.shared)
          Spacer()
        }
